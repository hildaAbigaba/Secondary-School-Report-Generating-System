...
?>
<div id="nextdate">
  <form id="form1" name="form1" method="post" action="nextdateprocess6.php">
...
<div id="INITIALS" style="padding-top:60px;">
  <form id="form2" name="form2" method="post" action="sixinitials.php">
...
<th colspan="2" align="center" bgcolor="#46643D"><font color="#FFFFFF">Enter New Students</font></th>
  <tr>
  <form action="addstudentsprocess6.php" method="post">
