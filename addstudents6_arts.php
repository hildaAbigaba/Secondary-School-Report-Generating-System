...
?>
<div id="nextdate">
  <form id="form1" name="form1" method="post" action="nextdateprocess6_arts.php">
...
<div id="INITIALS" style="padding-top:60px;">
  <form id="form2" name="form2" method="post" action="sixinitials_arts.php">
   <table width="200" border="1" style="border-collapse:collapse;">
      ...
      <tr>
        ...
        <td><input type="text" name="HIST" size="12" value="<?php echo $rowZ['HIST'];?>"/></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input type="text" name="LUGA" size="12" value="<?php echo $rowZ['LUGA'];?>"/></td>
      </tr>
      <tr>
...
<th colspan="2" align="center" bgcolor="#45543D"><font color="#FFFFFF">Enter New Students</font></th>
  <tr>
  <form action="addstudentsprocess6_arts.php" method="post">
...
<p align="right"><a href="six_arts.php"><img src="images/back.png" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
</div>
