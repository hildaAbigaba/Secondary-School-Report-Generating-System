...
<body>
<div id="apDiv1">
<p align="right"><a href="five_arts.php" title="Go Back"><<</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" title="Print Report" onclick="window.print()">Print </a></P>
...
<table width="1035" border="1" cellpadding="-10px" bordercolor="#000"  align="center" height="400px" style="background-image:url(images/t-bg.png); background-position:center; border-collapse:collapse; font-size:22px; font-family:Arial Narrow;">
  ...
  <tr>
   ...
   //This code updates the 5arts_grading table
	...
	?>&nbsp;</td>
    <td align="center"><span style="color:#FF0000; font-size:32px; font-weight:bold;"><?php echo"$ict"?></span></td>
     <td align="center" style="color:#1b5e94;"><?php 
	//This code selects the remark in the 5arts_grading table
