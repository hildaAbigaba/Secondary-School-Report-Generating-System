...
echo'<font color="#FF0000" size="+1">';echo"$date";echo'</font>';?>&nbsp;&nbsp;<a href="six_arts.php" title="Go Back"><<</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" title="Print Report" onclick="window.print()">Print </a></P> 
<table   width="1000" border="1" style="border-collapse:collapse; margin-top:20px; font-family:'Agency FB';" align="center">
<thead>
<tr>
<th colspan="16" style="font-weight:600; color:#009900; font-family:'Agency FB';" align="left"><?php $result = mysql_query( "select count(id) as num_rows from s6_arts" );
...
$sql_events = mysql_query("select * from s6_arts order by points DESC") or die (mysql_error()); 
